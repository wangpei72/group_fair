...
if __name__ == '__main__':
    ...
    while id_list_cnt < 5:
        ...
        tmp_di = np.load('./adult-testres/di_res' + id_list[id_list_cnt] + '.npy', allow_pickle=True)
        tmp_spd = np.load('./adult-testres/spd_res' + id_list[id_list_cnt] + '.npy')
        ...
        if id_list_cnt == 4:
            ...
            avg_spd /= 5.
            # avg_acc /= 5.
            np.save('adult-testres/res_avg/di_avg.npy', avg_di)
            np.save('adult-testres/res_avg/spd_avg.npy', avg_spd)
